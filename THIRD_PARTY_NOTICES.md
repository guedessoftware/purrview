...
|---|---|---|---|
| Qt 6 | 6.5 ou superior; runtime Flatpak 6.8 | LGPL-3.0/GPL-3.0/comercial, conforme distribuição | https://www.qt.io |
| Exiv2 | 0.28 ou superior; fallback Flatpak 0.28.8 | GPL-2.0-or-later | https://exiv2.org |
| KDE Flatpak Runtime | ramo 6.8 | Conjunto de licenças informado pelo runtime | https://invent.kde.org/packaging/flatpak-kde-runtime |
