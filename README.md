...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/versão-0.8.3-ff7f83?style=flat-square" alt="Versão 0.8.3">
...
|---|---|---|
| Ubuntu, Mint, Zorin e Debian | `purrview_0.8.3_amd64.deb` | `sudo apt install ./purrview_0.8.3_amd64.deb` |
| Fedora, openSUSE e derivados RPM | `purrview-0.8.3-1.x86_64.rpm` | `sudo dnf install ./purrview-0.8.3-1.x86_64.rpm` |
| Arch, Garuda, EndeavourOS e Manjaro | `purrview-0.8.3-1-x86_64.pkg.tar.zst` | `sudo pacman -U ./purrview-0.8.3-1-x86_64.pkg.tar.zst` |
| Linux com Flatpak | `PurrView-0.8.3-x86_64.flatpak` | `flatpak install --user ./PurrView-0.8.3-x86_64.flatpak` |
