...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/versão-0.8.11-ff7f83?style=flat-square" alt="Versão 0.8.11">
...
|---|---|---|
| Ubuntu, Mint, Zorin e Debian | `purrview_0.8.11_amd64.deb` | `sudo apt install ./purrview_0.8.11_amd64.deb` |
| Fedora, AlmaLinux, openSUSE e derivados RPM | `purrview-0.8.11-1.x86_64.rpm` | `sudo dnf install ./purrview-0.8.11-1.x86_64.rpm` |
| Arch, Garuda, EndeavourOS e Manjaro | `purrview-0.8.11-1-x86_64.pkg.tar.zst` | `sudo pacman -U ./purrview-0.8.11-1-x86_64.pkg.tar.zst` |
| Linux com Flatpak | `PurrView-0.8.11-x86_64.flatpak` | `flatpak install --user ./PurrView-0.8.11-x86_64.flatpak` |
| Instalação nativa assistida | `PurrView-0.8.11-bootstrap.tar.xz` | Execute `scripts/install-impage.sh --user` |
| Compilação manual | `PurrView-0.8.11-source.tar.xz` | Consulte [docs/building.md](docs/building.md) |
...
flatpak install --user ./PurrView-0.8.11-x86_64.flatpak
